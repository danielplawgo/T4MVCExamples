...
{
    public static T4MVCExamples.Controllers.HomeController Home = new T4MVCExamples.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class Images {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            public static readonly string Visual_Studio_2013_Logo_svg_png = Url("Visual_Studio_2013_Logo.svg.png");
        }
